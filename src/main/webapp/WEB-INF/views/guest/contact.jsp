            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="space-y-4">
                    <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
                        ...
                        <p class="text-gray-500 text-sm">Jhapa<br>Koshi Province, Nepal</p>
                    </div>
                    <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
                        ...
                        <p class="text-gray-500 text-sm">+977 9824009974</p>
                    ...
                    <form method="post" action="${pageContext.request.contextPath}/contact" class="space-y-5">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                            <div>
                                ...
                                <input type="text" name="name" required placeholder="Ishan Kafle"
                            ...
                            <div>
                                ...
                                <input type="email" name="email" required placeholder="sujansubedi@example.com"
